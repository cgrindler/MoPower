...
//Voltage:
output Real[2] Vr3(start={1.0,0.0});
output Real[2] Vr4(start={1.0,0.0});
output Real[2] Vr5(start={1.0,0.0});
output Real[2] Vr6(start={1.0,0.0});
output Real[2] Vr7(start={1.0,0.0});
output Real[2] Vr8(start={1.0,0.0});
output Real[2] Vr9(start={1.0,0.0});
output Real[2] Vr10(start={1.0,0.0});
output Real[2] Vr11(start={1.0,0.0});
output Real[2] Vr12(start={1.0,0.0});
output Real[2] Vr14(start={1.0,0.0});
output Real[2] Vr15(start={1.0,0.0});
output Real[2] Vr16(start={1.0,0.0});
output Real[2] Vr17(start={1.0,0.0});
output Real[2] Vr18(start={1.0,0.0});
output Real[2] Vr19(start={1.0,0.0});
output Real[2] Vr20(start={1.0,0.0});
output Real[2] Vr21(start={1.0,0.0});
output Real[2] Vr24(start={1.0,0.0});
output Real[2] Vr25(start={1.0,0.0});
output Real[2] Vr26(start={1.0,0.0});
output Real[2] Vr28(start={1.0,0.0});
output Real[2] Vr29(start={1.0,0.0});
output Real[2] Vr30(start={1.0,0.0});
...
input Real[2] ceq_Il30(start = {0,0});
...
Complex(Sl30[1],Sl30[2])=Complex(Vr30[1],Vr30[2])*Complex(Il30[1],-Il30[2]);
...
Complex(0,0) = Complex(Vr5[1],Vr5[2])*Complex((-2.9585798816568047),7.100591715976331) + Complex(Vr6[1],Vr6[2])*Complex((-4.10958904109589),10.95890410958904) + Complex(Vr7[1],Vr7[2])*Complex(7.068168922752695,(-18.049495825565373)) + Complex(Il_7[1],Il_7[2]);

Complex(0,0) = Complex(Vr6[1],Vr6[2])*Complex((-5.88235294117647),23.52941176470588) + Complex(Vr8[1],Vr8[2])*Complex(7.258499730167296,(-28.106567728008635)) + Complex(Vr28[1],Vr28[2])*Complex((-1.3761467889908257),4.587155963302752) + Complex(Il_8[1],Il_8[2]);
...
Complex(0,0) = Complex(Vr12[1],Vr12[2])*Complex((-1.4634146341463414),3.1707317073170733) + Complex(Vr14[1],Vr14[2])*Complex(3.952102416951771,(-5.4331751462311)) + Complex(Vr15[1],Vr15[2])*Complex((-2.4886877828054295),2.262443438914027) + Complex(Il_14[1],Il_14[2]);

Complex(0,0) = Complex(Vr12[1],Vr12[2])*Complex((-3.2110091743119273),5.963302752293578) + Complex(Vr14[1],Vr14[2])*Complex((-2.4886877828054295),2.262443438914027) + Complex(Vr15[1],Vr15[2])*Complex(9.517878775299176,(-15.862109827571242)) + Complex(Vr18[1],Vr18[2])*Complex((-1.8181818181818181),3.6363636363636362) + Complex(Vr23[1],Vr23[2])*Complex((-2.0),4.0) + Complex(Il_15[1],Il_15[2]);

Complex(0,0) = Complex(Vr12[1],Vr12[2])*Complex((-1.871101871101871),4.158004158004158) + Complex(Vr16[1],Vr16[2])*Complex(3.7534548122783415,(-8.628592393298277)) + Complex(Vr17[1],Vr17[2])*Complex((-1.8823529411764706),4.470588235294118) + Complex(Il_16[1],Il_16[2]);

Complex(0,0) = Complex(Vr10[1],Vr10[2])*Complex((-4.10958904109589),10.95890410958904) + Complex(Vr16[1],Vr16[2])*Complex((-1.8823529411764706),4.470588235294118) + Complex(Vr17[1],Vr17[2])*Complex(5.99194198227236,(-15.429492344883158)) + Complex(Il_17[1],Il_17[2]);

Complex(0,0) = Complex(Vr15[1],Vr15[2])*Complex((-1.8181818181818181),3.6363636363636362) + Complex(Vr18[1],Vr18[2])*Complex(4.745011086474501,(-9.977827050997783)) + Complex(Vr19[1],Vr19[2])*Complex((-2.926829268292683),6.341463414634147) + Complex(Il_18[1],Il_18[2]);

Complex(0,0) = Complex(Vr18[1],Vr18[2])*Complex((-2.926829268292683),6.341463414634147) + Complex(Vr19[1],Vr19[2])*Complex(8.09924306139613,(-18.410428931875526)) + Complex(Vr20[1],Vr20[2])*Complex((-5.1724137931034475),12.068965517241379) + Complex(Il_19[1],Il_19[2]);

Complex(0,0) = Complex(Vr10[1],Vr10[2])*Complex((-1.7241379310344827),4.022988505747127) + Complex(Vr19[1],Vr19[2])*Complex((-5.1724137931034475),12.068965517241379) + Complex(Vr20[1],Vr20[2])*Complex(6.896551724137931,(-16.091954022988507)) + Complex(Il_20[1],Il_20[2]);

Complex(0,0) = Complex(Vr10[1],Vr10[2])*Complex((-5.1724137931034475),12.068965517241379) + Complex(Vr21[1],Vr21[2])*Complex(25.17241379310345,(-52.06896551724138)) + Complex(Vr22[1],Vr22[2])*Complex((-20.0),40.0) + Complex(Il_21[1],Il_21[2]);
...
Complex(Ig23[1],Ig23[2]) = Complex(Vr15[1],Vr15[2])*Complex((-2.0),4.0) + Complex(Vr23[1],Vr23[2])*Complex(3.447661469933185,(-7.006681514476615)) + Complex(Vr24[1],Vr24[2])*Complex((-1.4476614699331847),3.0066815144766146) + Complex(Il_23[1],Il_23[2]);

Complex(0,0) = Complex(Vr22[1],Vr22[2])*Complex((-2.564102564102564),3.846153846153846) + Complex(Vr23[1],Vr23[2])*Complex((-1.4476614699331847),3.0066815144766146) + Complex(Vr24[1],Vr24[2])*Complex(5.322108861621956,(-9.128297429595976)) + Complex(Vr25[1],Vr25[2])*Complex((-1.3103448275862069),2.2758620689655173) + Complex(Il_24[1],Il_24[2]);
...
Complex(0,0) = Complex(Vr25[1],Vr25[2])*Complex((-1.2083131947800871),1.8366360560657322) + Complex(Vr26[1],Vr26[2])*Complex(1.2083131947800871,(-1.8366360560657322)) + Complex(Il_26[1],Il_26[2]);
...
Complex(0,0) = Complex(Vr27[1],Vr27[2])*Complex((-0.9786476868327402),1.8683274021352312) + Complex(Vr29[1],Vr29[2])*Complex(1.901369716821206,(-3.5984312083636047)) + Complex(Vr30[1],Vr30[2])*Complex((-0.9227220299884659),1.7301038062283736) + Complex(Il_29[1],Il_29[2]);

Complex(0,0) = Complex(Vr27[1],Vr27[2])*Complex((-0.6920415224913495),1.2975778546712804) + Complex(Vr29[1],Vr29[2])*Complex((-0.9227220299884659),1.7301038062283736) + Complex(Vr30[1],Vr30[2])*Complex(1.6147635524798154,(-3.027681660899654)) + Complex(Il_30[1],Il_30[2]);
