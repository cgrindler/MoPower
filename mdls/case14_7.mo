...
//Voltage:
output Real[2] Vr4(start={1.002483316814592,-0.1827243812642808});
output Real[2] Vr5(start={1.0080473578375984,-0.1556936875940605});
output Real[2] Vr7(start={1.0332167072184912,-0.24557531619561992});
output Real[2] Vr9(start={1.0203033258334908,-0.2722446019540472});
output Real[2] Vr10(start={1.0147117350540655,-0.2737902385834234});
output Real[2] Vr11(start={1.0219794311557528,-0.2698278011891353});
output Real[2] Vr12(start={1.018717387780199,-0.2742988950657429});
output Real[2] Vr13(start={1.0134592669592999,-0.27459117650485176});
output Real[2] Vr14(start={0.9956675156231685,-0.2862554773847789});
...
Complex(Ig2[1],Ig2[2]) = Complex(Vr1[1],Vr1[2])*Complex((-4.999131600798035),15.263086523179553) + Complex(Vr2[1],Vr2[2])*Complex(9.521323610814779,(-30.272115398779064)) + Complex(Vr3[1],Vr3[2])*Complex((-1.1350191923073958),4.781863151757718) + Complex(Vr4[1],Vr4[2])*Complex((-1.686033150614943),5.115838325872083) + Complex(Vr5[1],Vr5[2])*Complex((-1.7011396670944048),5.193927397969713) + Complex(Il_2[1],Il_2[2]);

Complex(Ig3[1],Ig3[2]) = Complex(Vr2[1],Vr2[2])*Complex((-1.1350191923073958),4.781863151757718) + Complex(Vr3[1],Vr3[2])*Complex(3.1209949022329564,(-9.82238012935164)) + Complex(Vr4[1],Vr4[2])*Complex((-1.9859757099255606),5.0688169775939205) + Complex(Il_3[1],Il_3[2]);

Complex(0,0) = Complex(Vr2[1],Vr2[2])*Complex((-1.686033150614943),5.115838325872083) + Complex(Vr3[1],Vr3[2])*Complex((-1.9859757099255606),5.0688169775939205) + Complex(Vr4[1],Vr4[2])*Complex(10.512989522036175,(-38.654171207607796)) + Complex(Vr5[1],Vr5[2])*Complex((-6.840980661495672),21.578553981691588) + Complex(Vr7[1],Vr7[2])*Complex(0.0,4.889512660317341) + Complex(Vr9[1],Vr9[2])*Complex(0.0,1.8554995578159006) + Complex(Il_4[1],Il_4[2]);

Complex(0,0) = Complex(Vr1[1],Vr1[2])*Complex((-1.025897454970189),4.234983682334831) + Complex(Vr2[1],Vr2[2])*Complex((-1.7011396670944048),5.193927397969713) + Complex(Vr4[1],Vr4[2])*Complex((-6.840980661495672),21.578553981691588) + Complex(Vr5[1],Vr5[2])*Complex(9.568017783560265,(-35.533639456044824)) + Complex(Vr6[1],Vr6[2])*Complex(0.0,4.257445335253384) + Complex(Il_5[1],Il_5[2]);

Complex(Ig6[1],Ig6[2]) = Complex(Vr5[1],Vr5[2])*Complex(0.0,4.257445335253384) + Complex(Vr6[1],Vr6[2])*Complex(6.579923407466222,(-17.34073280991911)) + Complex(Vr11[1],Vr11[2])*Complex((-1.9550285631772604),4.0940743442404415) + Complex(Vr12[1],Vr12[2])*Complex((-1.525967440450974),3.1759639650294003) + Complex(Vr13[1],Vr13[2])*Complex((-3.0989274038379877),6.102755448193116) + Complex(Il_6[1],Il_6[2]);
...
Complex(0,0) = Complex(Vr4[1],Vr4[2])*Complex(0.0,1.8554995578159006) + Complex(Vr7[1],Vr7[2])*Complex(0.0,9.09008271975275) + Complex(Vr9[1],Vr9[2])*Complex(5.326055039467359,(-24.092506375267877)) + Complex(Vr10[1],Vr10[2])*Complex((-3.902049552447428),10.365394127060915) + Complex(Vr14[1],Vr14[2])*Complex((-1.4240054870199312),3.0290504569306034) + Complex(Il_9[1],Il_9[2]);

Complex(0,0) = Complex(Vr9[1],Vr9[2])*Complex((-3.902049552447428),10.365394127060915) + Complex(Vr10[1],Vr10[2])*Complex(5.782934306147828,(-14.768337876521436)) + Complex(Vr11[1],Vr11[2])*Complex((-1.8808847537003996),4.402943749460521) + Complex(Il_10[1],Il_10[2]);

Complex(0,0) = Complex(Vr6[1],Vr6[2])*Complex((-1.9550285631772604),4.0940743442404415) + Complex(Vr10[1],Vr10[2])*Complex((-1.8808847537003996),4.402943749460521) + Complex(Vr11[1],Vr11[2])*Complex(3.83591331687766,(-8.497018093700962)) + Complex(Il_11[1],Il_11[2]);

Complex(0,0) = Complex(Vr6[1],Vr6[2])*Complex((-1.525967440450974),3.1759639650294003) + Complex(Vr12[1],Vr12[2])*Complex(4.014992027272893,(-5.427938591201612)) + Complex(Vr13[1],Vr13[2])*Complex((-2.4890245868219187),2.251974626172212) + Complex(Il_12[1],Il_12[2]);

Complex(0,0) = Complex(Vr6[1],Vr6[2])*Complex((-3.0989274038379877),6.102755448193116) + Complex(Vr12[1],Vr12[2])*Complex((-2.4890245868219187),2.251974626172212) + Complex(Vr13[1],Vr13[2])*Complex(6.724946148466233,(-10.66969354947068)) + Complex(Vr14[1],Vr14[2])*Complex((-1.1369941578063267),2.314963475105352) + Complex(Il_13[1],Il_13[2]);

Complex(0,0) = Complex(Vr9[1],Vr9[2])*Complex((-1.4240054870199312),3.0290504569306034) + Complex(Vr13[1],Vr13[2])*Complex((-1.1369941578063267),2.314963475105352) + Complex(Vr14[1],Vr14[2])*Complex(2.560999644826258,(-5.344013932035955)) + Complex(Il_14[1],Il_14[2]);
